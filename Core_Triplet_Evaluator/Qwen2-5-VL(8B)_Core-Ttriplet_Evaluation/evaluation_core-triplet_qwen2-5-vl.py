...
def main():
    parser = argparse.ArgumentParser(description="Evaluate action triplets with Qwen2.5-VL.")
    ...
    parser.add_argument("--triplet_json", type=str, default="Data/Evaluation_Data/Golden_label.json")
    parser.add_argument("--output_json", type=str, default="Output/output_Qwen2_5_VL(8B)_Golden_label.json")
