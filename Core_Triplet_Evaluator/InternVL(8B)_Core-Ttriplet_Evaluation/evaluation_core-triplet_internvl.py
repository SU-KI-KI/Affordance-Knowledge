...
def main():
    parser = argparse.ArgumentParser(description="Evaluate action triplets with InternVL3.5.")
    ...
    parser.add_argument("--output_json", type=str, default="Output/output_InternVL(8B)_Golden_label.json")
