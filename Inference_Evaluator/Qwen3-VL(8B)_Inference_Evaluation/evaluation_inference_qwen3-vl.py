...
def main():
    parser = argparse.ArgumentParser(description="Evaluate affordance-centric inference records with Qwen3-VL.")
    ...
    parser.add_argument("--output_json", type=str, default="Output/output_inference_Qwen3-VL(8B)_GPT4o_verified.json")
